...
import static com.vtv.inspection.service.check.FrontAxleCheckStep.DANGEROUS_OBSERVATIONS;
import static com.vtv.inspection.service.check.FrontAxleCheckStep.WARNING_OBSERVATIONS;
...
public class FrontAxleCheckStepTest {
    @Mock
    ...
    @InjectMocks
    private FrontAxleCheckStep frontAxleCheckStep;

    private final static CheckableStepName CHECKABLE_STEP_NAME = CheckableStepName.FRONT_AXLE;
    ...
    void shouldCheckSuccessfullyWith_SuccessfullyStatus() {
        ...
        final CheckableStepResult checkableStepResult = frontAxleCheckStep.check(CAR_PLATE);
