...
import static com.vtv.inspection.service.check.SuspensionSystemCheckStep.DANGEROUS_OBSERVATIONS;
import static com.vtv.inspection.service.check.SuspensionSystemCheckStep.WARNING_OBSERVATIONS;
...
public class SuspensionSystemCheckStepTest {
    private final static CheckableStepName CHECKABLE_STEP_NAME = CheckableStepName.SUSPENSION_SYSTEM;
    ...
    @InjectMocks
    private SuspensionSystemCheckStep suspensionSystemCheckStep;
    ...
    void shouldCheckSuccessfullyWith_SuccessfullyStatus() {
        ...
        final CheckableStepResult checkableStepResult = suspensionSystemCheckStep.check(CAR_PLATE);
