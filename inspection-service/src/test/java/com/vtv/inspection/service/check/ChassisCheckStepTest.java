...
import static com.vtv.inspection.service.check.ChassisCheckStep.DANGEROUS_OBSERVATIONS;
import static com.vtv.inspection.service.check.ChassisCheckStep.WARNING_OBSERVATIONS;
...
public class ChassisCheckStepTest {
    ...
    @InjectMocks
    private ChassisCheckStep chassisCheckStep;

    private final static String CAR_PLATE = "KPK123";

    private final static CheckableStepName CHECKABLE_STEP_NAME = CheckableStepName.CHASSIS;
    ...
    void shouldCheckSuccessfullyWith_SuccessfullyStatus() {
        ...
        final CheckableStepResult checkableStepResult = chassisCheckStep.check(CAR_PLATE);
