...
import static com.vtv.inspection.service.check.SafetyDevicesCheckStep.DANGEROUS_OBSERVATIONS;
import static com.vtv.inspection.service.check.SafetyDevicesCheckStep.WARNING_OBSERVATIONS;
...
public class SafetyDevicesCheckStepTest {
    private final static CheckableStepName CHECKABLE_STEP_NAME = CheckableStepName.SAFETY_DEVICES;
    ...
    @InjectMocks
    private SafetyDevicesCheckStep safetyDevicesCheckStep;
    ...
    void shouldCheckSuccessfullyWith_SuccessfullyStatus() {
        ...
        final CheckableStepResult checkableStepResult = safetyDevicesCheckStep.check(CAR_PLATE);
