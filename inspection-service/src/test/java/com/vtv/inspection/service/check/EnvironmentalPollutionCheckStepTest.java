...
import static com.vtv.inspection.service.check.EnvironmentalPollutionCheckStep.DANGEROUS_OBSERVATIONS;
import static com.vtv.inspection.service.check.EnvironmentalPollutionCheckStep.WARNING_OBSERVATIONS;
...
public class EnvironmentalPollutionCheckStepTest {
    @Mock
    ...
    @InjectMocks
    private EnvironmentalPollutionCheckStep environmentalPollutionCheckStep;

    private final static CheckableStepName CHECKABLE_STEP_NAME = CheckableStepName.ENVIRONMENTAL_POLLUTION;
    ...
    void shouldCheckSuccessfullyWith_SuccessfullyStatus() {
        ...
        final CheckableStepResult checkableStepResult = environmentalPollutionCheckStep.check(CAR_PLATE);
