...
import static com.vtv.inspection.service.check.BrakingSystemCheckStep.DANGEROUS_OBSERVATIONS;
import static com.vtv.inspection.service.check.BrakingSystemCheckStep.WARNING_OBSERVATIONS;
...
public class BrakingSystemCheckStepTest {
    ...
    @InjectMocks
    private BrakingSystemCheckStep brakingSystemCheckStep;

    private final static String CAR_PLATE = "KPK123";

    private final static CheckableStepName CHECKABLE_STEP_NAME = CheckableStepName.BRAKING_SYSTEM;
     ...
     void shouldCheckSuccessfullyWith_SuccessfullyStatus() {
         ...
         final CheckableStepResult checkableStepResult = brakingSystemCheckStep.check(CAR_PLATE);
