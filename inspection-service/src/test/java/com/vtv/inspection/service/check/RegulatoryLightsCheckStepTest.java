...
import static com.vtv.inspection.service.check.RegulatoryLightsCheckStep.DANGEROUS_OBSERVATIONS;
import static com.vtv.inspection.service.check.RegulatoryLightsCheckStep.WARNING_OBSERVATIONS;
...
public class RegulatoryLightsCheckStepTest {
    private final static CheckableStepName CHECKABLE_STEP_NAME = CheckableStepName.REGULATORY_LIGHTS;
    ...
    @InjectMocks
    private RegulatoryLightsCheckStep regulatoryLightsCheckStep;
    ...
    void shouldCheckSuccessfullyWith_SuccessfullyStatus() {
        ...
        final CheckableStepResult checkableStepResult = regulatoryLightsCheckStep.check(CAR_PLATE);
